...
export sem=$( curl -s https://raw.githubusercontent.com/myridwan/src/ipuk/versions)
...
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e "${BICyan} "                                                                      
echo -e "${BICyan} ⇲  ${BICyan}Use Core        :  ${BIYellow}$ Vluks Store"    
...
echo -e " ${BICyan}[${BIWhite}05${BICyan}]${RED} •${NC} ${CYAN}S-SOCK MENU     $NC  ${BICyan}[${BIWhite}16${BICyan}]${RED} • ${NC}${CYAN}SPEEDTEST  $NC"
...
21) clear ; clearlog ;;
#99) clear ; update ;;
22) clear ; wget https://raw.githubusercontent.com/Vlukss/asd/main/cf.sh && chmod +x cf.sh && ./cf.sh ;;
